...
class UserApi extends Api{
     ...
     */
    public function register($username, $nickname, $password, $email, $mobile, $store_code){
        return $this->model->register($username, $nickname, $password, $email, $mobile, $store_code);
    }

...
class MconfigController extends AdminController {
	...
	public function index(){
		...
		if(is_numeric($keys)){
            ...
            $map['id'] = array('like', '%'.(string)$keys.'%');
        }
		$list = M('mall_config')->where($map)->page($pageindex,$pagesize)->select();
		...
		// 	}
		// }
		$count = M('mall_config')->where($map)->count();
		if($count > $pagesize) {

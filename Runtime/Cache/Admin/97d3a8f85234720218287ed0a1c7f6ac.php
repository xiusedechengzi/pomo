		...
		<div class="search-form fr cf">
			<div class="sleft">
                ...
                <select name="mall" id="mall">
                    ...
                    <?php if(is_array($mall)): foreach($mall as $key=>$v): ?><option value="<?php echo ($v['id']); ?>" <?php if(($_GET['mall_id']) == $v[id]): ?>selected<?php endif; ?> ><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
                </select>
            </div>
			<div class="sleft">
				<input type="text" name="keys" class="search-input" value="<?php echo I('keys');?>" placeholder="请输入店铺名称或者ID">
		...
		<table>
			...
			<tbody>
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
						...
						<td><?php echo ($list["store_name"]); ?></a></td>
						<td><?php echo ($list["store_id"]); ?></a></td>
						<td><?php echo ($list["effective_time"]); ?></td>
						<td><?php echo ($list["end_time"]); ?></td>
						<td><?php echo ($list["payend_time"]); ?></td>
						<td><?php echo ($list["deduction"]); ?></a></td>
						<td><?php echo ($list["pay_period"]); ?></a></td>
						<td><?php echo ($list["pay_bank"]); ?></td>
						<td><?php echo ($list["bank_account"]); ?></td>
						<td><?php echo ($list["deposit"]); ?></td>
						<td><?php echo ($list["had_deposit"]); ?></a></td>
						<td><?php echo ($list["bill_title"]); ?></a></td>
						<td><?php echo ($list["addtime"]); ?></td>
						<td><?php echo ($list["add_member_id"]); ?></td>
						<td><?php echo ($list["status"]); ?></td>
						<td>
							<a title="编辑" href="<?php echo U('edit?id='.$list['id']);?>" class="btn">编辑</a>
							<a class="btn" title="删除" href="<?php echo U('del?id='.$list['id']);?>">删除</a>
							<!-- <a class="btn" title="合同" href="<?php echo U('contract?id='.$list['id']);?>">合同管理</a>
							<a class="btn" title="合同" href="<?php echo U('accountList?id='.$list['id']);?>">财务对账</a> -->
						</td>

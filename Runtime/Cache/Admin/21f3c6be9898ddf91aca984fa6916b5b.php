...
<body>
    ...
    <div class="main-title">
        <h2><?php echo ($list['id']?'编辑':'新增'); ?>顾客</h2>
    </div>
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            <label class="item-label">手机号</label>
            <div class="controls">
                <input type="text" class="text input-large" name="mobile" value="<?php echo ((isset($list["mobile"]) && ($list["mobile"] !== ""))?($list["mobile"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">昵称</label>
            <div class="controls">
                <input type="text" class="text input-large" name="nickname" value="<?php echo ((isset($list["nickname"]) && ($list["nickname"] !== ""))?($list["nickname"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">头像</label>
            <div class="controls">
                <input type="text" class="text input-large" name="head" value="<?php echo ((isset($list["head"]) && ($list["head"] !== ""))?($list["head"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">客户端ID</label>
            <div class="controls">
                <input type="text" class="text input-large" name="clientid" value="<?php echo ((isset($list["clientid"]) && ($list["clientid"] !== ""))?($list["clientid"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">最后登录时间</label>
            <div class="controls">
                <input type="text" class="text input-large" name="lasttime" value="<?php echo ((isset($list["lasttime"]) && ($list["lasttime"] !== ""))?($list["lasttime"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">所在地</label>
            <div class="controls">
                <input type="text" class="text input-large" name="place" value="<?php echo ((isset($list["place"]) && ($list["place"] !== ""))?($list["place"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">喜好</label>
            <div class="controls">
                <input type="text" class="text input-large" name="hobby" value="<?php echo ((isset($list["hobby"]) && ($list["hobby"] !== ""))?($list["hobby"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">生日</label>
            <div class="controls">
                <input type="text" class="text input-large" name="mobile" value="<?php echo ((isset($list["birthday"]) && ($list["birthday"] !== ""))?($list["birthday"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">状态</label>
            <div class="controls">
                <input type="text" class="text input-large" name="status" value="<?php echo ((isset($list["status"]) && ($list["status"] !== ""))?($list["status"]):''); ?>">
            </div>
        </div>
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav('<?php echo U('User/fuser');?>');
    </script>

	...
	<div class="cf">
		...
		<div class="search-form fl cf">
			...
			<div class="sleft" style="float:left;">
				<input type="text" name="keys" class="search-input" value="<?php echo I('keys');?>" placeholder="id/phone/喜爱/最后登录时间">
		...
		<table>
			...
			<tbody>
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
						...
						<td><?php echo ($list["store_code"]); ?></a></td>
						<td><img src="/onethink<?php echo ($list["logo"]); ?>" width="40px" height="40px"/></td>
						<td><?php echo ($list["mall_id"]); ?></td>
